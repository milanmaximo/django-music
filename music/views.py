...
def create_album(request):
    ...
    if form.is_valid():
        ...
        album.save()
        messages.success(request, f'Album "{album.album_title}" created successfully!')
        return redirect('music:detail', album_id=album.id)
    context = {
        "form": form,
    }
    return render(request, 'music/create_album.html', context)
...
def create_song(request, album_id):
    ...
    if form.is_valid():
        ...
        song.save()
        messages.success(request, f'Song "{song.song_title}" added successfully!')
        return redirect('music:detail', album_id=album.id)
    context = {
        'album': album,
        'form': form,
